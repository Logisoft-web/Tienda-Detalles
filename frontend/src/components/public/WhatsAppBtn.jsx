...
export default function WhatsAppBtn() {
  return (
    <a
      ...
      className="fixed bottom-20 right-4 lg:bottom-6 z-50 bg-green-500 hover:bg-green-600 text-white rounded-full w-14 h-14 flex items-center justify-center shadow-lg transition-transform hover:scale-110 active:scale-95"
    >
      {/* WhatsApp SVG icon */}
